                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ old('email') == null ? Auth::user()->email : old('email') }}" />
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="nidn" class="form-control @error('nidn') is-invalid @enderror" id="nidn"
                                name="nidn" value="{{ old('nidn') == null ? Auth::user()->nidn : old('nidn') }}" />
                            @error('nidn')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="select2 form-select col-sm-12 @error('study_programs_id') is-invalid @enderror"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="select2 form-select col-sm-12 @error('departements_id') is-invalid @enderror"
                                name="departments_id">
